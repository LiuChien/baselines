...
class Model(object):
    ...
    def __init__(self, policy, env, nsteps, log_dir=None,
            ent_coef=0.01, vf_coef=0.5, max_grad_norm=0.5, lr=7e-4, div_coef=0.0004,
        ...
        div = div * div_coef
        div = tf.clip_by_value(div, clip_value_min=0, clip_value_max=1, name='clipped_diversity')
        
        loss = pg_loss - entropy * ent_coef + vf_loss * vf_coef - div
